...
#ifndef PPUC_PPUCGENERALILLUMINATIONWPC_H
#define PPUC_PPUCGENERALILLUMINATIONWPC_H
...
class PPUCGeneralIlluminationWPC {
public:
    PPUCGeneralIlluminationWPC(PPUCEventDispatcher *eD) {
        ...
        pinMode(5, INPUT);
        pinMode(6, INPUT);
        pinMode(12, INPUT_PULLUP); // Inverted on PPUC Adapter.
    }
...
#endif //PPUC_PPUCGENERALILLUMINATIONWPC_H
